...
<head>
    ...
    <script type="text/javascript" src="/Scripts/tiny_mce/utils/mctabs.js"></script>
    <script type="text/javascript" src="/Scripts/tiny_mce/utils/form_utils.js"></script>
    <script type="text/javascript" src="/Scripts/tiny_mce/utils/validate.js"></script>
    <script type="text/javascript" src="/Scripts/tiny_mce/utils/editable_selects.js"></script>
    <script type="text/javascript" src="/Scripts/tiny_mce/plugins/netadvimage/js/jquery.js"></script>
    <script type="text/javascript" src="/Scripts/tiny_mce/plugins/netadvimage/js/jquery-ui.js"></script>
    <script type="text/javascript" src="/Scripts/tiny_mce/plugins/netadvimage/js/jquery.layout.js"></script>
    <script type="text/javascript" src="/Scripts/tiny_mce/plugins/netadvimage/js/dialog.js"></script>
    <script type="text/javascript" src="/Scripts/tiny_mce/plugins/netadvimage/js/fileuploader.js"></script>
    <link href="/Scripts/tiny_mce/plugins/netadvimage/css/dialog.css" rel="stylesheet" type="text/css" />
    <link href="/Scripts/tiny_mce/plugins/netadvimage/css/fileuploader.css" rel="stylesheet" type="text/css" />
    ...
    <div class="panel_wrapper">
        <div id="upload_panel" class="panel current">
            <div class="ui-layout-center">
                ...
                <div id="prompt">
                    <img src="/Scripts/tiny_mce/plugins/netadvimage/img/arrow.gif" alt="<--" />
                ...
                <div class="options img-options">
                    <ul>
                        <li><a href="#" title="Delete selected image" id="img-delete" class="t-drop">
                            <img src="/Scripts/tiny_mce/plugins/netadvimage/img/bin.gif" alt="Delete image" /></a></li>
                        <!--<li><a title="Rename selected image" href="#" id="img-edit" class="t-drop">
                            <img src="/Scripts/tiny_mce/plugins/netadvimage/img/pencil.gif" alt="Edit directory" /></a></li>-->
                        <li><a href="#" title="Add directory" class="img-upload">
                            <img src="/Scripts/tiny_mce/plugins/netadvimage/img/plus.gif" alt="Upload image" /></a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="options dir-options">
                    <ul>
                        <li><a href="#" title="Delete selected directory" id="dir-delete" class="t-drop">
                            <img src="/Scripts/tiny_mce/plugins/netadvimage/img/bin.gif" alt="Delete directory" /></a></li>
                        <li><a href="#" title="Rename selected directory" id="dir-edit" class="t-drop">
                            <img src="/Scripts/tiny_mce/plugins/netadvimage/img/pencil.gif" alt="Edit directory" /></a></li>
                        <li><a href="#" title="Add directory" id="dir-add">
                            <img src="/Scripts/tiny_mce/plugins/netadvimage/img/plus.gif" alt="Add directory" /></a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td rowspan="6" valign="top">
                            <div class="alignPreview">
                                <img id="alignSampleImg" src="/Scripts/tiny_mce/plugins/netadvimage/img/sample.gif" alt="Sample image" />
